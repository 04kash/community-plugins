...
const generateNewPackageName = (name: string) =>
  name.replace(`@janus-idp/backstage-plugin`, `@backstage-community/plugin`);
...
async function updateCatalogInfoYaml(
  ...
  const replacements = {
    'https://github.com/janus-idp/backstage-plugins/tree/main': `https://github.com/backstage/community-plugins/tree/main/workspaces/${workspaceName}`,
    'https://github.com/janus-idp/backstage-plugins/blob/main': `https://github.com/backstage/community-plugins/blob/main/workspaces/${workspaceName}`,
    'https://github.com/janus-idp/backstage-plugins/edit/main': `https://github.com/backstage/community-plugins/edit/main/workspaces/${workspaceName}`,
    'janus-idp/maintainers-plugins': 'backstage/maintainers-plugins',
    'sonarqube.org/project-key: janus-idp_backstage-plugins':
      'sonarqube.org/project-key: backstage-community_plugins',
    'janus-idp-backstage': 'backstage-community',
    'janus-idp': 'backstage-community',
    rhdh: 'backstage',
  };
